...
Процедура ДоступностьФормы()
	...
	Если Объект.Статус = Перечисления.СтатусыПриходныхОрдеров.Принят Тогда 
		Если (Объект.Отправитель = Справочники.Склады.НайтиПоНаименованию("ГП Склад готовой продукции") И Объект.Склад = Справочники.Склады.НайтиПоНаименованию("ЦК Цех Комплектации")) ИЛИ
			(Объект.Отправитель = Справочники.Склады.НайтиПоНаименованию("ЦК Цех Комплектации") И Объект.Склад = Справочники.Склады.НайтиПоНаименованию("ЦК Цех Комплектации")) ИЛИ
			(Объект.Отправитель = Справочники.Склады.НайтиПоНаименованию("ГП Склад готовой продукции") И Объект.Склад = Справочники.Склады.НайтиПоНаименованию("ГП Склад готовой продукции")) Тогда
...
&НаКлиенте
Процедура Расш1_ПриПовторномОткрытииПосле()
	а = 1;
КонецПроцедуры
